...
public class CommodityController {
    ...
    public JSONObject relgoodsvideo(@RequestParam(value = "file", required = false) MultipartFile file) throws IOException {
       ...
       // String pathname = "G:\\项目源码\\java\\java汇总\\008-Java精品源码-在线游戏商城系统\\game-trading-website-master\\target\\classes\\static\\pic\\" + filenames;
        //String pathname = request.getServletContext().getRealPath("/static/pic/");
    ...
    @ResponseBody
    public JSONObject relgoodsimages(@RequestParam(value = "pic", required = false) MultipartFile[] file) throws IOException {
        JSONObject res = new JSONObject();
        JSONObject resUrl = new JSONObject();
