...
public interface CommodityMapper {
    ...
    /**产品清单分类分页展示商品*/
    List<Commodity> queryAllCommodityByCategory(@Param("page") Integer page, @Param("count") Integer count, @Param("area") String area, @Param("server") String server,
                                                @Param("category") String category, @Param("minmoney") BigDecimal minmoney, @Param("maxmoney") BigDecimal maxmoney);
    /**查询产品清单分类分页展示商品的总数*/
    Integer queryAllCommodityByCategoryCount(@Param("area") String area, @Param("server") String server, @Param("category") String category,
