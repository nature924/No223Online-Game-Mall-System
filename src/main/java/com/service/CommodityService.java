...
public class CommodityService {
    ...
    /**产品清单分类分页展示商品*/
    public List<Commodity> queryAllCommodityByCategory(Integer page,Integer count,String area,String server,String category,BigDecimal minmoney,BigDecimal maxmoney){
        return commodityMapper.queryAllCommodityByCategory(page,count,area,server,category,minmoney,maxmoney);
    }
    /**查询产品清单分类分页展示商品的总数*/
    public Integer queryAllCommodityByCategoryCount(String area, String server, String category, BigDecimal minmoney, BigDecimal maxmoney){
        return commodityMapper.queryAllCommodityByCategoryCount(area,server,category,minmoney,maxmoney);
    }
}
